...
const roleNavigationMap = {
  'Normal User': [
    { id: 'dashboard', label: 'Dashboard', icon: <Home className="w-5 h-5" />, path: '/app/dashboard' },
    { id: 'performance', label: 'Performance', icon: <BarChart3 className="w-5 h-5" />, path: '/app/performance' },
    { id: 'completed', label: 'Completed Papers', icon: <CheckCircle className="w-5 h-5" />, path: '/app/completed-papers' },
    { id: 'create', label: 'Create Your Exam', icon: <Plus className="w-5 h-5" />, path: '/app/create-exam' },
    { id: 'upload', label: 'Upload Answers', icon: <Upload className="w-5 h-5" />, path: '/app/omr-upload' },
    { id: 'mathematics', label: 'Mathematics', icon: <Calculator className="w-5 h-5" />, path: '/app/subject/mathematics' },
    { id: 'english', label: 'English', icon: <BookOpen className="w-5 h-5" />, path: '/app/subject/english' },
    { id: 'verbal', label: 'Verbal Reasoning', icon: <Brain className="w-5 h-5" />, path: '/app/subject/verbal' },
    { id: 'nonverbal', label: 'Non-Verbal Reasoning', icon: <Puzzle className="w-5 h-5" />, path: '/app/subject/nonverbal' },
  ...
  'Teacher': [
    ...
    { id: 'performance', label: 'Performance', icon: <BarChart3 className="w-5 h-5" />, path: '/app/performance' },
    { id: 'completed', label: 'Completed Papers', icon: <CheckCircle className="w-5 h-5" />, path: '/app/completed-papers' },
    { id: 'virtual-classes', label: 'Virtual Classes', icon: <Video className="w-5 h-5" />, path: '/app/virtual-classes' },
    { id: 'students', label: 'Students', icon: <Users className="w-5 h-5" />, path: '/app/students' },
    { id: 'create', label: 'Create Your Exam', icon: <Plus className="w-5 h-5" />, path: '/app/create-exam' },
    { id: 'upload', label: 'Upload Answers', icon: <Upload className="w-5 h-5" />, path: '/app/omr-upload' },
    { id: 'mathematics', label: 'Mathematics', icon: <Calculator className="w-5 h-5" />, path: '/app/subject/mathematics' },
    { id: 'english', label: 'English', icon: <BookOpen className="w-5 h-5" />, path: '/app/subject/english' },
  ...
  'Admin': [
    { id: 'admin-dashboard', label: 'Admin Dashboard', icon: <Home className="w-5 h-5" />, path: '/app/dashboard1' },
    { id: 'admin-overview', label: 'Admin Overview Panel', icon: <BarChart3 className="w-5 h-5" />, path: '/app/admin/overview1' },
    { id: 'admin-user-management', label: 'Admin User Management1', icon: <Users className="w-5 h-5" />, path: '/app/admin/user-management1' },
    { id: 'admin-course-management', label: 'Admin Course & Topic Management1', icon: <BookOpen className="w-5 h-5" />, path: '/app/admin/course-topic-management1' },
    { id: 'admin-exam-management', label: 'Admin Exam Management1', icon: <CheckCircle className="w-5 h-5" />, path: '/app/admin/exam-management1' },
    { id: 'admin-omr-logs', label: 'Admin OMR Upload Logs1', icon: <Upload className="w-5 h-5" />, path: '/app/admin/omr-upload-logs1' },
    { id: 'admin-analytics', label: 'Admin Analytics1', icon: <BarChart3 className="w-5 h-5" />, path: '/app/admin/analytics1' },
    { id: 'admin-teacher-monitoring', label: 'Admin Teacher Monitoring1', icon: <GraduationCap className="w-5 h-5" />, path: '/app/admin/teacher-monitoring1' },
    { id: 'admin-content-moderation', label: 'Admin Content Moderation1', icon: <Shield className="w-5 h-5" />, path: '/app/admin/content-moderation1' },
    { id: 'admin-subscription-plans', label: 'Admin Subscription Plans1', icon: <Award className="w-5 h-5" />, path: '/app/admin/subscription-plans1' },
    { id: 'admin-coupon-management', label: 'Admin Coupon Management1', icon: <Trophy className="w-5 h-5" />, path: '/app/admin/coupon-management1' },
    { id: 'admin-user-subscriptions', label: 'Admin User Subscriptions1', icon: <User className="w-5 h-5" />, path: '/app/admin/user-subscriptions1' },
    { id: 'admin-reports-stats', label: 'Admin Reports & Usage Stats1', icon: <BarChart3 className="w-5 h-5" />, path: '/app/admin/reports-usage-stats1' },
    { id: 'admin-manual-overrides', label: 'Admin Manual Overrides1', icon: <Settings className="w-5 h-5" />, path: '/app/admin/manual-overrides1' },
    { id: 'admin-ai-usage-logs', label: 'Admin AI Usage Logs1', icon: <MessageSquare className="w-5 h-5" />, path: '/app/admin/ai-usage-logs1' },
    { id: 'admin-settings', label: 'Admin Settings1', icon: <Settings className="w-5 h-5" />, path: '/app/admin/settings1' }
  ],
  'Student': [
    { id: 'dashboard', label: 'Dashboard', icon: <Home className="w-5 h-5" />, path: '/app/dashboard' },
    { id: 'my-classes', label: 'My Classes', icon: <GraduationCap className="w-5 h-5" />, path: '/app/my-classes' },
    { id: 'my-exams', label: 'My Exams', icon: <BookMarked className="w-5 h-5" />, path: '/app/my-exams' },
    { id: 'upload', label: 'Upload Answers', icon: <Upload className="w-5 h-5" />, path: '/app/omr-upload' },
    { id: 'results', label: 'Results', icon: <Award className="w-5 h-5" />, path: '/app/results' },
...
export default function DashboardLayout() {
  ...
  const getActiveSection = () => {
    ...
    // Check for new admin paths with "1" suffix
    if (path.startsWith('/app/admin/')) {
      const adminPath = path.replace('/app/admin/', '')
      // Map admin paths to their corresponding navigation IDs
      const adminPathMap: { [key: string]: string } = {
        'overview1': 'admin-overview',
        'user-management1': 'admin-user-management',
        'course-topic-management1': 'admin-course-management',
        'exam-management1': 'admin-exam-management',
        'omr-upload-logs1': 'admin-omr-logs',
        'analytics1': 'admin-analytics',
        'teacher-monitoring1': 'admin-teacher-monitoring',
        'content-moderation1': 'admin-content-moderation',
        'subscription-plans1': 'admin-subscription-plans',
        'coupon-management1': 'admin-coupon-management',
        'user-subscriptions1': 'admin-user-subscriptions',
        'reports-usage-stats1': 'admin-reports-stats',
        'manual-overrides1': 'admin-manual-overrides',
        'ai-usage-logs1': 'admin-ai-usage-logs',
        'settings1': 'admin-settings'
      }
      return adminPathMap[adminPath] || 'admin-overview'
    }
    
    // Check for admin dashboard
    if (path === '/app/dashboard1') return 'admin-dashboard'
    
    // Check for subject paths
    if (path.startsWith('/app/subject/')) {
      const subject = path.replace('/app/subject/', '')
      return subject
    }
    ...
    if (path === '/app/completed-papers') return 'completed'
    if (path === '/app/create-exam') return 'create'
    if (path === '/app/omr-upload') return 'upload'
    if (path === '/app/virtual-classes') return 'virtual-classes'
    if (path === '/app/students') return 'students'
    if (path === '/app/my-classes') return 'my-classes'
    if (path === '/app/my-exams') return 'my-exams'
    if (path === '/app/results') return 'results'
