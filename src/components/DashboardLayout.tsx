...
const roleNavigationMap = {
  ...
  'Admin': [
    ...
    { 
      ...
      hasChildren: true,
      children: [
        { id: 'admin-overview', label: 'Overview', path: '/app/admin/overview' },
        { id: 'admin-users', label: 'User Management', path: '/app/admin/user-management' },
        { id: 'admin-courses', label: 'Course & Topic Management', path: '/app/admin/course-topic-management' },
        { id: 'admin-exams', label: 'Exam Management', path: '/app/admin/exam-management' },
        { id: 'admin-omr', label: 'OMR Upload Logs', path: '/app/admin/omr-upload-logs' },
        { id: 'admin-analytics', label: 'Analytics', path: '/app/admin/analytics' },
        { id: 'admin-teachers', label: 'Teacher Monitoring', path: '/app/admin/teacher-monitoring' },
        { id: 'admin-content', label: 'Content Moderation', path: '/app/admin/content-moderation' },
        { id: 'admin-subscriptions', label: 'Subscription Plans', path: '/app/admin/subscription-plans' },
        { id: 'admin-coupons', label: 'Coupon Management', path: '/app/admin/coupon-management' },
        { id: 'admin-user-subscriptions', label: 'User Subscriptions', path: '/app/admin/user-subscriptions' },
        { id: 'admin-reports', label: 'Reports & Usage Stats', path: '/app/admin/reports-usage-stats' },
        { id: 'admin-overrides', label: 'Manual Overrides', path: '/app/admin/manual-overrides' },
        { id: 'admin-ai-logs', label: 'AI Usage Logs', path: '/app/admin/ai-usage-logs' },
        { id: 'admin-settings', label: 'Settings', path: '/app/admin/settings' }
      ]
    }
  ],
  'Student': [
  ...
  const getActiveSection = () => {
    ...
    if (path.startsWith('/app/admin/')) {
      ...
      const adminPathMap: { [key: string]: string } = {
        ...
        'course-topic-management': 'admin-courses',
        'exam-management': 'admin-exams',
        'omr-upload-logs': 'admin-omr',
        'analytics': 'admin-analytics',
        'teacher-monitoring': 'admin-teachers',
        ...
        'reports-usage-stats': 'admin-reports',
        'manual-overrides': 'admin-overrides',
